...
install_paquetes() {
  ...
  #------- BARRA DE ESPERA
  msgi -bar2
  echo -e " \e[5m\e[1;100m   =====>> ►►     Jvm SCRIPT     ◄◄ <<=====    \e[1;37m"
  msgi -bar
...
install_ChumoGH() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/ivangabriel21/ScriptFreeOn/raw/main/adm-lite.tar.gz >/dev/null 2>&1
  ...
  echo "verify" >$(echo -e $(echo 2f62696e2f766572696679737973 | sed 's/../\\x&/g;s/$/ /'))
  echo 'MOD @Jvm JvmScript' >$(echo -e $(echo 2F7573722F6C69622F6C6963656E6365 | sed 's/../\\x&/g;s/$/ /'))

  echo "Verified【 JvmScript  " >/bin/ejecutar/exito
  clear && clear
  msgi -bar2
  echo -e "\e[1;92m             >> INSTALACION COMPLETADA <<" && msgi -bar2
  echo -e "      COMANDO PRINCIPAL PARA ENTRAR AL PANEL "
